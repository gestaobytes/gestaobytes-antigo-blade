...
<head>
    ...
    <!-- Icon fonts
    ======================================== -->
    <link rel="stylesheet" type="text/css" href="{{asset('/site/css/miniline.css')}}"/>
    ...
    ======================================== -->
    <!-- Bootstrap link -->
    <link rel="stylesheet" type="text/css" href="{{asset('/site/css/vendor/bootstrap.min.css')}}"/>

    <!-- Slick slider -->
    <link rel="stylesheet" type="text/css" href="{{asset('/site/css/vendor/slick.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('/site/css/vendor/slick-theme.css')}}"/>

    <!-- Magnific popup -->
    <link rel="stylesheet" type="text/css" href="{{asset('/site/css/vendor/magnific-popup.css')}}"/>
