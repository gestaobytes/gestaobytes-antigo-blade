                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class='table-date'>
                                                ...
                                                <br/><i class='zmdi zmdi-time'></i>
                                                {{ \Carbon\Carbon::parse($inicio)->format('G:i')}}
                                            </td>
                                            <td class='table-date'>
                                                {{ \Carbon\Carbon::parse($fim)->format('d/m/Y')}}
                                                <br/><i class='zmdi zmdi-time'></i>
                                                {{ \Carbon\Carbon::parse($fim)->format('G:i')}} 
                                            </td>
                                            <td class='table-date' colspan='3'></td>
                     
                                            <td class='table-date' colspan='2'>
                                                <div class='progress progress-bar-lg'>
                                                    <div class='progress-bar progress-bar-success' 
                                                         role='progressbar' aria-valuenow='51' aria-valuemin='0' 
                                                         aria-valuemax='100' style='width: {{$progressoProjeto}}%'>
                                                    </div>
                                                </div>
                                            </td>
