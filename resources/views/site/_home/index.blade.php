...
<head>
    ...
    <link rel="manifest" href="{{asset('/front/favicon/manifest.json')}}"/>
            ...
            <div class="featured-project-showcase text-center">
                <div class="row equalHeightWrapper">
                    ...
                    <div class="grid-item col-md-6 col-lg-4">
                        <a href="#" class="featured-content-block content-block" data-toggle="modal" data-target="#featured-project-modal">
                            <div class="img-container">
                                <img src="{{asset('/front/images/featured-projects/featured-project-1.jpg')}}" alt="Project image" class="img-fluid">
                            </div>
                    ...
                    <div class="grid-item col-md-6 col-lg-4">
                        <a href="#" class="featured-content-block content-block" data-toggle="modal" data-target="#featured-project-modal">
                            <div class="img-container">
                                <img src="{{asset('/front/images/featured-projects/featured-project-2.jpg')}}" alt="Project image" class="img-fluid">
                            </div>
                            <!-- End of .img-container -->
                            <h5 class="equalHeight">
                                <span class="content-block__sub-title">Web Design</span>
                    ...
                    <div class="grid-item col-md-6 col-lg-4">
                        <a href="#" class="featured-content-block content-block" data-toggle="modal" data-target="#featured-project-modal">
                            <div class="img-container">
                                <img src="{{asset('/front/images/featured-projects/featured-project-3.jpg')}}" alt="Project image" class="img-fluid">
                            </div>
                            <!-- End of .img-container -->
                            <h5 class="equalHeight">
                    ...
                    <div class="grid-item col-md-6 col-lg-4">
                        <a href="#" class="featured-content-block content-block" data-toggle="modal" data-target="#featured-project-modal">
                            <div class="img-container">
                                <img src="{{asset('/front/images/featured-projects/featured-project-4.jpg')}}" alt="Project image" class="img-fluid">
                            </div>
                            <!-- End of .img-container -->
                            <h5 class="equalHeight">
                                <span class="content-block__sub-title">Web Design</span>
                    ...
                    <div class="grid-item col-md-6 col-lg-4">
                        <a href="#" class="featured-content-block content-block" data-toggle="modal" data-target="#featured-project-modal">
                            <div class="img-container">
                                <img src="{{asset('/front/images/featured-projects/featured-project-5.jpg')}}" alt="Project image" class="img-fluid">
                            </div>
                            <!-- End of .img-container -->
                            <h5 class="equalHeight">
                                <span class="content-block__sub-title">Web Design</span>
                    ...
                    <div class="grid-item col-md-6 col-lg-4">
                        <a href="#" class="featured-content-block content-block" data-toggle="modal" data-target="#featured-project-modal">
                            <div class="img-container">
                                <img src="{{asset('/front/images/featured-projects/featured-project-6.jpg')}}" alt="Project image" class="img-fluid">
                            </div>
                            <!-- End of .img-container -->
                            <h5 class="equalHeight">
                                <span class="content-block__sub-title">Web Design</span>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="img-container col-lg-6">
                    <img src="{{asset('/front/images/case-study/case-study-slide-1.png')}}" alt="case study image" class="img-fluid"/>
                </div>
            </div>
        </div>
        <!-- End of .container -->
    ...
    <div class="clients">
        <div class="container">
            <div class="row justify-content-center clients-wrapper">
                <div class="client">
                    <img src="{{asset('/front/images/clients/client-1.png')}}" alt="clients' logo">
                </div>
                <div class="client">
                    <img src="{{asset('/front/images/clients/client-2.png')}}" alt="clients' logo">
                </div>
                <div class="client">
                    <img src="{{asset('/front/images/clients/client-3.png')}}" alt="clients' logo">
                </div>
                <div class="client">
                    <img src="{{asset('/front/images/clients/client-4.png')}}" alt="clients' logo">
                </div>
                <div class="client">
                    <img src="{{asset('/front/images/clients/client-5.png')}}" alt="clients' logo">
                </div>
                <div class="client">
                    <img src="{{asset('/front/images/clients/client-6.png')}}" alt="clients' logo">
                </div>
                <div class="client">
                    <img src="{{asset('/front/images/clients/client-7.png')}}" alt="clients' logo">
                </div>
            </div>
        </div>
        <!-- End of .container -->
            ...
            <div class="carousel-container equalHeightWrapper">
                <div class="item">
                    <a href="blog-details.html" class="news-content-block content-block">
                        <div class="img-container">
                            <img src="{{asset('/front/images/news/news-1.jpg')}}" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                ...
                <div class="item">
                    <a href="blog-details.html" class="news-content-block content-block">
                        <div class="img-container">
                            <img src="{{asset('/front/images/news/news-2.jpg')}}" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                ...
                <div class="item">
                    <a href="blog-details.html" class="news-content-block content-block">
                        <div class="img-container">
                            <img src="{{asset('/front/images/news/news-3.jpg')}}" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                ...
                <div class="item">
                    <a href="blog-details.html" class="news-content-block content-block">
                        <div class="img-container">
                            <img src="{{asset('/front/images/news/news-4.jpg')}}" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                ...
                <div class="item">
                    <a href="blog-details.html" class="news-content-block content-block">
                        <div class="img-container">
                            <img src="{{asset('/front/images/news/news-5.jpg')}}" alt="Project image" class="img-fluid">
                        </div>
                        <!-- End of .img-container -->
                        <h5 class="equalHeight">
                            ...
                            <div id="featured-project-carousel" class="carousel slide featured-project-carousel"
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100 img-fluid" src="{{asset('/front/images/featured-projects/modal-img-1.jpg')}}"
                                            alt="First slide">
                                    </div>
